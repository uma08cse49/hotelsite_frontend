...
const SearchBar = () => {
  ...
  return (
    <div className="flex justify-center py-10">
      <div className="flex w-full max-w-3xl items-center rounded-full border border-gray-300 bg-white shadow-md overflow-hidden">
        {/* Where */}
        <div className="flex-1 px-4 py-3 border-r cursor-pointer">
        ...
        {/* Search Button */}
        <button
          className="bg-primary p-3 rounded-full m-2 text-white hover:bg-pink-700 flex items-center justify-center"
